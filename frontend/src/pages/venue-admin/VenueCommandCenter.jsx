...
export default function VenueCommandCenter() {
  ...
  const handleCommand = (cmd) => {
    if (cmd.path) {
      ...
      addNotification('COMMAND_BROADCAST', 'Emergency intelligence broadcasted to all active security nodes.', 'alert');
    }
  };
  ...
  return (
    <>
      <div className="grid-3-2-1" style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr 1fr', gap: 20, marginBottom: 20 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          >
            ...
            <div className="schedule-stack" style={{ minHeight: 180 }}>
              {venueEvents.filter(e => getDayName(e.date) === selectedDay).map((evt, i) => (
